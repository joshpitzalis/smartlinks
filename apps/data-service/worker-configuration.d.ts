/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface BaseEnv --env staging` (hash: 5edbdcaf4cc5f654c2d967bb44dddaa2)
// Runtime types generated with workerd@1.20260116.0 2025-06-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "EvaluationScheduler" | "LinkClickTracker" | "AdDataUpdateScheduler";
	}
	interface Env {
		CACHE: KVNamespace;
		...
		AD_UPDATE_SCHEDULER: DurableObjectNamespace<import("./src/index").AdDataUpdateScheduler>;
		BUCKET: R2Bucket;
		DB: D1Database;
		QUEUE: Queue;
		VIRTUAL_BROWSER: Fetcher;
		AI: Ai;
		FETCH_AD_WORKFLOW: Workflow<Parameters<import("./src/index").AdDataFetcher['run']>[0]['payload']>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SEARCH_API_KEY">> {}
}
