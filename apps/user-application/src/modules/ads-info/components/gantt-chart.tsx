				...
				{Object.entries(sortedGroupedFeatures).map(([group, features]) => (
					<GanttSidebarGroup key={group} name={group}>
						{features.map((feature) => (
							<GanttSidebarItem feature={feature} key={feature.ad_archive_id} />
						))}
					</GanttSidebarGroup>
				))}
			</GanttSidebar>
							...
							{features.map((feature) => (
								<div className="flex" key={feature.ad_archive_id}>
                                  ...
                                  <GlimpseDescription>{data.description}</GlimpseDescription>*/}
												...
												<AvatarFallback>{getBestImage(feature)}</AvatarFallback>
											</Avatar>
										)}
									</GanttFeatureItem>
								</div>
...
const getBestImage = (feature: AdSchemaType) => {
